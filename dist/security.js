...
// src/security/check-auth.ts
function checkAuth(association, allowedRoles) {
  const authorized = allowedRoles.includes(association);
  if (authorized) {
    info("\u2705 Authorization successful");
    info(`   User role '${association}' is allowed`);
    return true;
  }
  error("\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550");
  ...
  error("\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550");
  error("");
  error(`User association: ${association}`);
  error(`Allowed roles: ${JSON.stringify(allowedRoles)}`);
  error("");
  error("Only trusted contributors can trigger reviews.");
  error("Allowed: OWNER, MEMBER, COLLABORATOR");
  error("External contributors cannot use this action.");
  error("");
  error("If you are a maintainer, ensure you have appropriate");
  error("permissions in the repository.");
  error("\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550");
  return false;
}
...
function base62CRC32(s) {
  let checksum = BigInt(crc32(Buffer.from(s, "utf-8")));
  const out = new Array(GITHUB_CHECKSUM_LEN);
  for (let i = GITHUB_CHECKSUM_LEN - 1; i >= 0; i--) {
    out[i] = BASE62_ALPHABET[Number(checksum % 62n)];
    checksum /= 62n;
  }
  return out.join("");
}
...
function crc32(buf) {
  let crc = 4294967295;
  for (const b of buf) {
    crc = (CRC32_TABLE[(crc ^ b) & 255] ^ crc >>> 8) >>> 0;
  }
...
function isFalsePositive(line) {
  if (line.includes("SUSPICIOUS_PATTERNS") || line.includes("CRITICAL_PATTERNS") || line.includes("MEDIUM_RISK_PATTERNS")) {
    return true;
  }
  if (/^[+\s-]\s*['"].*[[\]{}()*+?^\\].*['"]\s*$/.test(line)) {
    return true;
...
function sanitizeInput(inputPath, outputPath) {
  const inputContent = readFileSync(inputPath, "utf-8");
  const inputLines = inputContent.split("\n");
  let outputLines = inputLines.filter((line) => !/^\+.*\/\//.test(line)).filter((line) => !/^\+.*\/\*/.test(line)).filter((line) => !/^\+\s*#/.test(line));
  info("\u{1F50D} Checking for suspicious patterns...");
  ...
  for (const pattern of CRITICAL_PATTERNS) {
    ...
    if (matches.length > 0) {
      error(`\u{1F6A8} CRITICAL pattern detected: ${pattern.source}`);
      error("This is a direct secret exfiltration command");
      foundCritical = true;
    }
  }
  for (const pattern of SUSPICIOUS_PATTERNS) {
    ...
    if (realMatches.length > 0) {
      warning(`\u26A0\uFE0F  Suspicious pattern stripped from prompt: ${pattern.source}`);
  ...
  for (const name of MEDIUM_RISK_PATTERNS) {
    ...
    if (realMatches.length > 0) {
      warning(`\u26A0\uFE0F  MEDIUM-RISK pattern detected: ${name}`);
      warning("This PR modifies API key configuration - review carefully");
      warning("Output will be scanned for actual secret leakage");
      foundMedium = true;
    }
  }
  if (foundCritical) {
    error(
      "\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\n\u{1F6A8} BLOCKED: CRITICAL SECRET EXFILTRATION DETECTED\n\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\nThe input contains commands that directly extract secrets.\nExecution has been blocked.\n\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550"
    );
    return { blocked: true, stripped: false, riskLevel: "high" };
  }
  writeFileSync(outputPath, outputLines.join("\n"), "utf-8");
  if (foundSuspicious) {
    info("\u26A0\uFE0F  Input sanitization completed - suspicious content stripped from prompt");
    info("   Stripped lines will not be passed to the agent");
    info("   Real security is in output scanning (will detect actual leaked secrets)");
    return { blocked: false, stripped: true, riskLevel: "medium" };
  }
  if (foundMedium) {
    info("\u26A0\uFE0F  Input sanitization completed with WARNINGS - proceeding with review");
    info("   Real security is in output scanning (will detect actual leaked secrets)");
    return { blocked: false, stripped: false, riskLevel: "medium" };
  }
  info("\u2705 Input sanitization completed - no suspicious patterns found");
  return { blocked: false, stripped: false, riskLevel: "low" };
}

// src/security/sanitize-output.ts
import { readFileSync as readFileSync2 } from "fs";
var REGEX_METACHAR_RE = /[[\]{}()*+?^$\\]/;
function sanitizeOutput(filePath) {
  const content = readFileSync2(filePath, "utf-8");
  info("Scanning output for leaked secrets...");
  let leaked = false;
  ...
  for (const pattern of SECRET_PATTERNS) {
    ...
    for (const match of content.matchAll(globalRe)) {
      ...
      if (REGEX_METACHAR_RE.test(matchedText)) {
        debug(`Skipping false positive (regex pattern): ${matchedText}`);
        continue;
      }
      const idx = match.index ?? 0;
      const isQuoted = idx > 0 && content[idx - 1] === "'" && content[idx + matchedText.length] === "'";
      if (isQuoted) {
        debug(`Skipping false positive (quoted occurrence): ${matchedText}`);
        continue;
      }
      if (pattern.validator && !pattern.validator(matchedText)) {
        debug(`Skipping false positive (validator rejected): ${matchedText}`);
        continue;
      }
      error(`\u{1F6A8} SECRET LEAK DETECTED: Pattern matched: ${pattern.name}`);
      leaked = true;
  ...
  if (mediumRe.test(content)) {
    warning("\u26A0\uFE0F  Environment variable names detected in output");
    warning("This may indicate an attempted information disclosure");
  }
  if (leaked) {
    error("\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550");
    error("\u{1F6A8} CRITICAL SECURITY INCIDENT: SECRET LEAK DETECTED");
    error("\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550");
    error("");
    error("Response contains secret patterns:");
    for (const p of detectedPatterns) {
      error(`  - ${p}`);
    }
    error("");
    error("ACTIONS TAKEN:");
    error("  \u2713 Response BLOCKED from being posted to PR");
    error("  \u2713 Security incident logged");
    error("  \u2713 Workflow will fail");
    error("");
    error("IMMEDIATE ACTIONS REQUIRED:");
    error("  1. Investigate PR for prompt injection");
    error("  2. Review AI response in workflow logs");
    error("  3. Rotate compromised secrets immediately");
    error("  4. Block the PR author if malicious");
    error("");
    error("DO NOT post this response to the PR!");
    error("\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550");
  } else {
    info("\u2705 No secrets detected in output - safe to post");
  }
...
if (subcommand === "check-auth") {
  ...
  let allowedRoles;
  try {
    allowedRoles = JSON.parse(rolesJson);
  } catch {
    setFailed(`Invalid JSON for allowed-roles: ${rolesJson}`);
    process.exit(1);
  }
  const authorized = checkAuth(association, allowedRoles);
  setOutput("authorized", String(authorized));
  if (!authorized) {
    process.exit(1);
  }
  ...
  if (!inputPath || !outputPath) {
    setFailed("sanitize-input requires <inputPath> <outputPath>");
    process.exit(1);
  }
  const result = sanitizeInput(inputPath, outputPath);
  setOutput("blocked", String(result.blocked));
  setOutput("stripped", String(result.stripped));
  ...
  if (!filePath) {
    setFailed("sanitize-output requires <filePath>");
    process.exit(1);
  }
  const result = sanitizeOutput(filePath);
  setOutput("leaked", String(result.leaked));
  if (result.leaked) {
    process.exit(1);
  }
} else {
  setFailed(`Unknown subcommand: ${subcommand ?? "(none)"}`);
  process.exit(1);
}
