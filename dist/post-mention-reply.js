...
// src/post-mention-reply/index.ts
...
// src/post-mention-reply/index.ts
var MARKER = "<!-- docker-agent-review-reply -->";
function log(msg) {
...
async function run(config) {
  const { secretsDetected, outputFile, owner, repo, prNumber, isInline, inReplyToId, token } = config;
